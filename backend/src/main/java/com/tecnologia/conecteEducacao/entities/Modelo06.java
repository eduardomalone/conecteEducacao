...
@Entity
@Table(name = "modelo06")
public class Modelo06 implements Serializable {
	...
	public Modelo06(Integer indice, int codnivel, String codconteudo, String bloco, String texto, String destaque) {
		super();
		this.indice = indice;
