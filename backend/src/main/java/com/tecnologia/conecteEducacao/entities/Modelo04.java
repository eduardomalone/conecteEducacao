...
@Entity
@Table(name = "modelo04")
public class Modelo04 implements Serializable {
	...
	public Modelo04(Integer indice, int codnivel, String codconteudo, String bloco, String texto, String imagem,
