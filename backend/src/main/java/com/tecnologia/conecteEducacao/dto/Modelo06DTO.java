...
public class Modelo06DTO implements Serializable{
	...
	public Modelo06DTO(Integer indice, int codnivel, String codconteudo, String bloco, String texto, String destaque) {
		this.indice = indice;
	...
	public Modelo06DTO(Modelo06 entity) {
