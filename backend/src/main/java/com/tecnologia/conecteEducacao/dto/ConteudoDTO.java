...
public class ConteudoDTO implements Serializable{
	...
	public ConteudoDTO(Integer indice, Integer codnivel, String codconteudo, String titulo, String bloco01,
			String bloco02, String bloco03, String bloco04, String bloco05, String bloco06, String bloco07,
			String bloco08, String bloco09, String bloco10, Integer statustt, Integer status01, Integer status02,
			Integer status03, Integer status04, Integer status05, Integer status06, Integer status07, Integer status08,
			Integer status09, Integer status10, Integer status, Integer statusrd, Integer rodpro, Integer rodant,
			Integer codescola, Integer codusuario, String tipo) {
	...
	public void setStatust(Integer statustt) {
		this.statustt = statustt;
	}
